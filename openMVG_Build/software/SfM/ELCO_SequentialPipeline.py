...
OPENMVG_SFM_BIN = "/home/pi/Downloads/openMVG_Build2/Linux-armv7l-RELEASE"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/pi/Downloads/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
print ("7. Export to CMVS-PMVS")
pPMVS = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_openMVG2PMVS"), "-i", reconstruction_dir+"/robust.bin", "-o", reconstruction_dir] )
pPMVS.wait()
